                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid lg:grid-cols-3 gap-8">
                            ...
                            <ProjectCard
                                ...
                                downloadLink="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.1.3/ATSIT-Finanzas-Setup-1.1.3.exe"
                                downloadText="Descargar Windows (.exe)"
                                trialBadge="15 Días de Prueba"
                                osBadge="Windows Nativo"
                                updateBadge="v1.1.3 — Actualizado: 22/09/2026"
                            ...
                            <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
                                    ...
                                    <div className="relative rounded-[2.5rem] overflow-hidden border border-white/15 shadow-2xl group-hover:scale-[1.02] transition-transform duration-700">
                                        ...
                                        <div className="absolute top-4 left-4 flex flex-wrap gap-2">
                                            ...
                                            <span className="bg-emerald-400 text-slate-950 font-black text-[10px] uppercase tracking-widest px-3.5 py-1.5 rounded-full shadow-xl flex items-center gap-1.5">
                                                <CheckCircle2 size={12} /> v1.1.3 — Actualizado 22/09/2026 (Sudamérica)
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="lg:col-span-7 flex flex-col justify-between">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-6 border-t border-white/10">
                                        <a
                                            href="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.1.3/ATSIT-Finanzas-Setup-1.1.3.exe"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                    ...
                                    <p className="text-[11px] text-emerald-300 mt-4 text-center sm:text-left font-medium flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/30 p-2.5 rounded-xl">
                                        ...
                                        <span><strong>Versión v1.1.3 Publicada:</strong> 22/09/2026 — Edición Sudamérica (Instalador ejecutable Windows).</span>
                                    </p>
                                </div>
                            </div>
                        </motion.div>

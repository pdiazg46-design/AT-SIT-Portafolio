                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid lg:grid-cols-3 gap-8">
                            ...
                            <ProjectCard
                                ...
                                downloadLink="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.0.4/ATSIT-Finanzas-Setup-1.0.4.exe"
                                downloadMacLink="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.0.4/ATSIT-Finanzas-Mac-Intel.dmg"
                                downloadText="Descargar Windows (.exe)"
                                trialBadge="15 Días de Prueba"
                                osBadge="Windows & macOS"
                                updateBadge="v1.0.4 — Actualizado: 02/08/2026"
                            ...
                            <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
                                ...
                                <div className="lg:col-span-7 flex flex-col justify-between">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-6 border-t border-white/10">
                                        <a
                                            href="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.0.4/ATSIT-Finanzas-Setup-1.0.4.exe"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        <a
                                            href="https://github.com/pdiazg46-design/ATSIT-Finanzas/releases/download/v1.0.4/ATSIT-Finanzas-Mac-Intel.dmg"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                    ...
                                    <p className="text-[11px] text-emerald-300 mt-4 text-center sm:text-left font-medium flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/30 p-2.5 rounded-xl">
                                        ...
                                        <span><strong>Versión v1.0.4 Publicada:</strong> 02/08/2026 — Instalador oficial para Windows y macOS (con soporte styled-jsx desempaquetado).</span>
                                    </p>
                                </div>
                            </div>
                        </motion.div>
    ...
    return (
        ...
        >
            ...
            <div className="p-10 pt-6 flex flex-col flex-grow relative pointer-events-none">
                ...
                <p className="text-slate-600 font-medium leading-relaxed mb-6 flex-grow pointer-events-auto">
                    {desc}
                </p>
                ...
                {downloadLink && downloadLink !== "#" ? (
                    ...
                    <div className="mb-6 inline-flex w-fit items-center gap-2 bg-slate-900/5 border border-slate-900/10 px-3 py-2 rounded-xl group-hover:bg-slate-900 group-hover:border-slate-900 transition-all duration-300 pointer-events-auto shadow-sm">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-700 group-hover:text-white transition-colors mt-[1px]">
                            Aplicación Privada <span className="text-slate-300 group-hover:text-white/30 mx-1.5">|</span> <span className="text-indigo-600 group-hover:text-amber-400">Contacta para personalizar</span>
                        </span>
                    </div>
                )}

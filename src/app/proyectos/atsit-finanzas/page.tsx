                            ...
                            <div className="p-8 rounded-3xl bg-gradient-to-br from-purple-950/80 via-slate-900 to-slate-950 border border-purple-500/30 shadow-2xl backdrop-blur-xl relative overflow-hidden">
                                ...
                                <div className="flex flex-wrap items-center gap-2 mb-4">
                                    ...
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-[10px] font-black uppercase tracking-wider">
                                        <CheckCircle2 size={12} /> v1.0.4 — Actualizado: 02/08/2026
                                    </span>
                                </div>
                                ...
                                <div className="pt-3 border-t border-white/10 flex items-center gap-2 text-xs text-slate-300 font-medium">
                                    ...
                                    <span><strong>Última Versión Publicada en Nube:</strong> v1.0.4 (02/08/2026) — Instalador oficial para Windows y macOS.</span>
                                </div>
                            </div>
                        </motion.div>

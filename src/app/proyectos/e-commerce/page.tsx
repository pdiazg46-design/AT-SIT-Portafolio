...
import { ArrowLeft, Globe, Database, Zap } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-950 text-white selection:bg-purple-500/30">
            ...
            <main className="pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                        ...
                        >
                            ...
                            <h1 className="text-6xl md:text-7xl font-black tracking-tighter mb-8 leading-tight">
                                E-Commerce <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Emprende</span>
                            </h1>
                            <p className="text-xl text-slate-300 font-medium leading-relaxed mb-8">
                                Motor de comercio electrónico B2C con un diseño oscuro premium. Integra un manejo de estado ultrasónico para el carrito de compras e inyección backend directa.
                            </p>
                            <div className="flex flex-wrap gap-3">
                                {["Next.js", "Supabase", "Zustand", "Prisma"].map(tag => (
                    ...
                    <h2 className="text-4xl font-black mb-16 tracking-tight text-center">Fuerza Técnica</h2>
                    <div className="grid md:grid-cols-3 gap-8 mb-32">
                        <ModuleCard
                            icon={<Zap className="text-indigo-400" />}
                            title="Zustand State"
                            desc="El carrito de compras y la sesión evaden latencias con un store global asíncrono puro."
                        />
                        <ModuleCard
                            icon={<Database className="text-cyan-400" />}
                            title="Supabase SSR"
                            desc="Escalamiento Serverless inmediato apoyado por validaciones en el Edge de Next.js."
                        />
                        <ModuleCard
                            icon={<Globe className="text-purple-400" />}
                            title="Premium UI"
                            desc="Presentación de productos impecable priorizando alta conversión bajo modo oscuro."
                        />
                    </div>
                </div>
            </main>
